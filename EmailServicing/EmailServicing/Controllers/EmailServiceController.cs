...
namespace EmailServicing.Controllers
{
    public class EmailServiceController : Controller
    {
        ...
        public ActionResult Index(EmailDto email)
        {
            //Have reached this point, so we can work with the emailing system now
            ...
            {
                //Log.Debug("The email Reviewer function is called");
                bool sent = false;
            ...
            public void EmailRecruiter(int candidateInvitiationKey, string currentUrl, RequestContext controllersContext)
            {
                ...
                var email = new EmailDto
                {
                    ...
                    ToEmailAddress = "drew@drwethomas.live"
                };
                //).FirstOrDefault();
            ...
            /// ----------------------------------------------------------------
            /// </history>
            //public string GenerateReveiwerResultsLink(string currentUrl, EmailDto email)
            //{
            ...
            /// ----------------------------------------------------------------
            /// </history>
            public string GenerateRecruiterResultsLink(string currentUrl, string urlSpec)
            {
